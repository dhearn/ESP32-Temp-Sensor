...
// Real 
DeviceAddress sensor1 = { 0x28, 0x03, 0x96, 0x75, 0xD0, 0x01, 0x3C, 0x85 }; // Outdoor temp
DeviceAddress sensor2 = { 0x28, 0x67, 0xCB, 0x43, 0x0C, 0x00, 0x00, 0xD9 }; // Boiler flow temp (double-joined sensor)
DeviceAddress sensor3 = { 0x28, 0xD7, 0xDE, 0x5B, 0x0D, 0x00, 0x00, 0xFF }; // Boiler return temp (end of cable sensor)

// Test
// TODO: DH - Update these now that I've swapped sensors around
// DeviceAddress sensor1 = { 0x28, 0x2E, 0x41, 0xEB, 0x04, 0x00, 0x00, 0xDC }; // Outdoor temp
// DeviceAddress sensor2 = { 0x28, 0x03, 0x96, 0x75, 0xD0, 0x01, 0x3C, 0x85 }; // Boiler flow temp
// DeviceAddress sensor3 = { 0x28, 0xFF, 0xAA, 0xDE, 0x91, 0x16, 0x05, 0x28 }; // Boiler return temp
// DeviceAddress sensor1 = { 0x28, 0x03, 0x96, 0x75, 0xD0, 0x01, 0x3C, 0x85 }; // Outdoor temp
// DeviceAddress sensor2 = { 0x28, 0x67, 0xCB, 0x43, 0x0C, 0x00, 0x00, 0xD9 }; // Boiler flow temp (double-joined sensor)
// DeviceAddress sensor3 = { 0x28, 0xD7, 0xDE, 0x5B, 0x0D, 0x00, 0x00, 0xFF }; // Boiler return temp (end of cable sensor)
